...
<div id="main">
    ...
    <section>
        <article>
            <pre class="prettyprint source"><code>/*  Copyright (c) 2012 Sven "FuzzYspo0N" Bergström
 ...
 * @constructor
 * @param {Game} game_instance - Optional parameter. Client player uses it.
 */
    var GameCore = function(game_instance){

        /** Store the instance, if an. */
...
<nav>
    <h2><a href="index.html">Index</a></h2><h3>Classes</h3><ul><li><a href="GameCore.html">GameCore</a></li></ul>
</nav>

<br clear="both">

<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.3.0-alpha2</a> on Sun Nov 17 2013 16:10:24 GMT-0300 (ART)
</footer>
